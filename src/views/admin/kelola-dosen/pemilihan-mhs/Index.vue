      ...
      <div class="col-lg-12 mt-lg-0 mt-4">
        ...
        <div class="bg-white card mt-4" :hidden="isLoading">
          ...
          <div class="pb-0 card-header">
            <div class="d-lg-flex">
              <div>
                <h5 class="mb-2">Data Seleksi Mahasiswa</h5>
                <p class="text-sm mb-0">Data seleksi mahasiswa KKN</p>
              </div>
                            ...
                            <div class="modal-body p-4">
                              ...
                              <div class="row mt-2">
                                ...
                                >
                                  ...
                                  &nbsp;
                                  <span
                                    v-if="pendaftaran.mahasiswa.foto_profile"
                                  >
                                    <a
                                      :id="
                                        pendaftaran.mahasiswa.foto_profile ?? ''
                                      "
                                      type="button"
                                      target="_blank"
                              ...
                              <div class="row mt-2">
                                ...
                                >
                                  ...
                                  >
                                  &nbsp;
                                  <span v-if="pendaftaran.mahasiswa.khs">
                                    <a
                                      :id="pendaftaran.mahasiswa.khs ?? ''"
                                      type="button"
                                      target="_blank"
                                ...
                                >
                                  ...
                                  <span
                                    v-if="
                                      pendaftaran.mahasiswa.surat_pernyataan
                                    "
                                  >
                                    <a
                                      :id="
...
export default {
  ...
  methods: {
    ...
    setupTableAction() {
      ...
      // pas foto
      $("#pendaftaran-list").on("click", `.pas-foto-button`, function (e) {
        let id = this.id;
      ...
      // khs
      $("#pendaftaran-list").on("click", `.khs-button`, function (e) {
        let id = this.id;
        outerThis.showSwal("loading");
        outerThis
          .a$getDokumenEmbedLink(id)
