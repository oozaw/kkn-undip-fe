              ...
              <table id="nilai-akhir-list" class="table table-flush">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-sm">249572834239</td>
                    <td class="text-sm">FPIK</td>
                    <td class="text-sm">65.2</td>
                  ...
                  <tr>
                    ...
                    <td class="text-sm">249572834239</td>
                    <td class="text-sm">FKM</td>
                    <td class="text-sm">43.5</td>
    ...
    if (document.getElementById("nilai-akhir-list")) {
      ...
      document.querySelectorAll(".export").forEach(function (el) {
        el.addEventListener("click", function () {
          ...
          var data = {
            type: type,
            filename: "Data Nilai Akhir " + tema,
          };
